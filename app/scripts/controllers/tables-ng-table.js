 ...
 */
 app
.controller('TablesNgTableCtrl', function($scope, DTOptionsBuilder, DTColumnDefBuilder){
    ...
    $scope.leaves =[{leaveType:"sick leave",From:date,To:new Date(y, m, d +3),comment:"Flu is killing me",attachment:"sick note"},
     ...
     $scope.meetings =[{meeting:"Scrum",comment:"rechel and onica must submit the ERD",duration:"30mins",dates:date},
                       {meeting:"Meeting with mentor",comment:"dev will start with back-end",duration:"1hrs",dates:date},
                       {meeting:"Meeting with BA's",comment:"need to finish the ERD",duration:"30mins",dates:date},
                        {meeting:"OP meeting",comment:"new communication channels is introduced",duration:"1hrs",dates:date}];
